<?php
    echo "<div id='footer'>
            <div class='clearfix'>
              ...
              <div id='contact_us'>
                ...
                <div id='contact_info_section'>
                  <p><b>Naslov:</b> Pot na Lavo 22, 3000 Celje</p>
                  <p><b>Telefon:</b> (03) 428 58 00 – centrala</p>
                  <p><b>E-mail:</b><a href='mailto:info@sc-celje.si'>info@sc-celje.si</a></p>
                </div>
              </div>
            ...
            <div id='copyright_note'>
              <p>© Bizjak, Grobelnik, Frece 2020</p>
            </div>
          </div>";
?>
